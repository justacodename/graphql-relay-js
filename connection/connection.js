...
const connectionArgs = { ...forwardConnectionArgs,
...
function connectionDefinitions(config) {
  var _config$name, _config$edgeFields, _config$connectionFie;

  const {
    nodeType
  } = config;
  const name = (_config$name = config.name) !== null && _config$name !== void 0 ? _config$name : nodeType.name;
  const edgeFields = (_config$edgeFields = config.edgeFields) !== null && _config$edgeFields !== void 0 ? _config$edgeFields : {};
  const connectionFields = (_config$connectionFie = config.connectionFields) !== null && _config$connectionFie !== void 0 ? _config$connectionFie : {};
